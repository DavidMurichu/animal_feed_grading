"""
Django settings for elevated project.
...
SECRET_KEY = 'django-insecure-9eb^(z27+_h&iyv5zgu#1c60!$&j+j19z-agi-4o42xhms0^lx'
...
WSGI_APPLICATION = 'elevated.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'elevated/static')]
